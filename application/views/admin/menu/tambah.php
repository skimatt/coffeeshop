...
<head>
    ...
    <title><?php echo isset($title) ? $title : 'Coffee Omwari - Tambah Menu'; ?></title>
    <meta name="description" content="Tambah menu minuman untuk Coffee Omwari." />
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-4 mb-6">Tambah Menu</h4>
                        <div class="card">
                            <div class="card-body">
                                <?php echo form_open('admin/menu_tambah'); ?>
                                    <div class="form-group">
                                        <label>Nama Menu</label>
                                        <input type="text" name="nama_menu" class="form-control" value="<?php echo set_value('nama_menu'); ?>">
                                    ...
                                    <div class="form-group">
                                        <label>Stok</label>
                                        <input type="number" name="stok" class="form-control" value="<?php echo set_value('stok'); ?>">
