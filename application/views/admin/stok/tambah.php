...
<head>
    ...
    <title><?php echo isset($title) ? $title : 'Coffee Omwari - Tambah Stok Bahan'; ?></title>
    <meta name="description" content="Tambah stok bahan untuk Coffee Omwari." />
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-4 mb-6">Tambah Stok Bahan</h4>
                        <div class="card">
                            <div class="card-body">
                                <?php echo form_open('admin/stok_tambah'); ?>
                                    ...
                                    <div class="form-group">
                                        <label>Jumlah</label>
                                        <input type="number" step="0.01" name="jumlah" class="form-control" value="<?php echo set_value('jumlah'); ?>">
