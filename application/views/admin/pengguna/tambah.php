...
<head>
    ...
    <title><?php echo isset($title) ? $title : 'Coffee Omwari - Tambah Pengguna'; ?></title>
    <meta name="description" content="Tambah pengguna untuk Coffee Omwari." />
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-4 mb-6">Tambah Pengguna</h4>
                        <div class="card">
                            <div class="card-body">
                                <?php echo form_open('admin/pengguna_tambah'); ?>
