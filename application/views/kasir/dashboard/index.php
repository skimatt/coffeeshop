...
<head>
    ...
    <title><?php echo isset($title) ? $title : 'Dashboard Kasir - Coffee Omwari'; ?></title>
    <meta name="description" content="Dashboard kasir untuk Coffee Omwari." />
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-4 mb-6">Dashboard Kasir</h4>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div>
                                                ...
                                                <h4 class="mb-0"><?php echo count($transaksi_hari_ini); ?></h4>
                                            </div>
